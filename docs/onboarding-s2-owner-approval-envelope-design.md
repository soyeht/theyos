...
Status: branch-only design note for Caio review. No runtime behavior is changed
by this document.

Base: `onboarding/s2-owner-approval-envelope` stacked on S1
`onboarding/s1-webauthn-rp-core`.
...
## Tests Required Before Caio Review
