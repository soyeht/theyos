...
use crate::machine_roster_authority::{
    ...
    RosterAuthorityContext, RosterCryptoError, UnavailableReason, admit_checkpoint,
    derive_machine_currency, derive_owner_binding_from_cert, historical_reapply_next,
};
