...
pub const PRODUCT_A_HTTP_ROOT: &str = "/api/v1/mobile/claw-vpn";
pub const PRODUCT_A_STATUS_PATH: &str = "/api/v1/mobile/claw-vpn/status";
...
/// Close the complete production app outside every route, fallback, and
