...
//! terminal PTY WebSocket routes that are intentionally deferred from the
//! cross-repo C4.2b-1 contract, so this test pins the overlap instead of
//! requiring both files to have the same full route set.
